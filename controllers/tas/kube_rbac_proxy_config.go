...
func (r *TrustyAIServiceReconciler) createKubeRBACProxyConfigMapObject(ctx context.Context, instance *trustyaiopendatahubiov1.TrustyAIService) (*corev1.ConfigMap, error) {
...
func (r *TrustyAIServiceReconciler) ensureKubeRBACProxyConfigMap(ctx context.Context, instance *trustyaiopendatahubiov1.TrustyAIService) error {
