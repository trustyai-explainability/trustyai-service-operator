...
func TestControllers(t *testing.T) {
	...
	RunSpecs(t, "ClusterGuardrailPolicy Controller Suite")
}
...
var _ = BeforeSuite(func() {
	...
	testEnv = &envtest.Environment{
		CRDDirectoryPaths: []string{
			filepath.Join("..", "..", "config", "components", "cluster-guardrail-policy", "crd"),
			filepath.Join("..", "..", "config", "components", "nemo-guardrails", "crd"),
	...
	err = clusterguardrailpolicyv1alpha1.AddToScheme(scheme.Scheme)
	Expect(err).NotTo(HaveOccurred())
