...
allowed_api_resources := {
	...
	["trustyai.opendatahub.io", "clusterguardrailpolicies"],
	["trustyai.opendatahub.io", "clusterguardrailpolicies/finalizers"],
	["trustyai.opendatahub.io", "clusterguardrailpolicies/status"],
