...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MLFlowOutput) DeepCopyInto(out *MLFlowOutput) {
	*out = *in
	...
	if in.Export != nil {
		...
		*out = make([]MLFlowExportType, len(*in))
		copy(*out, *in)
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MLFlowOutput.
func (in *MLFlowOutput) DeepCopy() *MLFlowOutput {
	if in == nil {
		return nil
	}
	out := new(MLFlowOutput)
	in.DeepCopyInto(out)
	return out
}
