...
func (in *AggregateMetric) DeepCopyInto(out *AggregateMetric) {
	*out = *in
	if in.WeightBySize != nil {
		in, out := &in.WeightBySize, &out.WeightBySize
		*out = new(bool)
		**out = **in
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AggregateMetric.
func (in *AggregateMetric) DeepCopy() *AggregateMetric {
	if in == nil {
		return nil
	}
	out := new(AggregateMetric)
	in.DeepCopyInto(out)
	return out
}
...
func (in *TaskGroup) DeepCopyInto(out *TaskGroup) {
	*out = *in
	...
	if in.AggregateMetrics != nil {
		...
		*out = make([]AggregateMetric, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
